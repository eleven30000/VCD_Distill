#!/usr/bin/env bash
# run_train_mme_lora64.sh
# Train VCDD-AW2 using the MME dataset with an expanded LoRA rank.
...
OUT_DIR="./output/llava_vcdd_aw_mme_lora64_lambda09"

echo ">>> Starting VCDD-AW distillation on MME (LoRA R=64)..."
