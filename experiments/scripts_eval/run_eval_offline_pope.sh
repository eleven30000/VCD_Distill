#!/usr/bin/env bash
# run_eval_offline_pope.sh
set -euo pipefail
cd "$(dirname "$0")"

MODEL_PATH="./output/llava_vcdd_offline_smoothaw0p8_lora64_lambda01"
BASE_MODEL="./checkpoints/llava-v1.5-7b"
POPE_OUT_DIR="./output/full_eval"
POPE_TAG="vcdd_offline_smoothaw0p8_lora64_lambda01"
...
echo "============================================================"
echo "  [Offline VCDD] Evaluating on POPE Benchmarks"
echo "============================================================"
