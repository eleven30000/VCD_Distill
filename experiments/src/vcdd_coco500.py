"""
vcdd_coco500.py - Offline VCD Distillation (VCDD-Offline) for LLaVA 1.5
...
def teacher_base_soft_labels(model, input_ids, img_clean, img_noisy,
    ...
    return p_ans_vcd, kl_clean_vcd.item(), p_ans_clean
    ...
    for epoch in range(args.epochs):
        ...
        for step, line in enumerate(tqdm(questions, desc=f"Epoch {epoch+1}")):
            ...
            if not args.sft_only:
                ...
                soft_labels, raw_cw, base_probs = teacher_base_soft_labels(
